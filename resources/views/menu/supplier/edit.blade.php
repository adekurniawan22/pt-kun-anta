    ...
    <main class="page-content">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <span class="text-dark">Edit Supplier</span>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row ms-0 me-1">
            <div class="card radius-10 w-100">
                <div class="card-body">
                    <form action="{{ route(session()->get('role') . '.supplier.update', $supplier->supplier_id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea id="alamat_supplier" name="alamat_supplier"
                                ...
                                placeholder="Masukkan alamat supplier">{{ old('alamat_supplier', $supplier->alamat_supplier) }}</textarea>
                            ...
                            <select name="bahan_baku[]" class="bahan-baku-select @error('bahan_baku') is-invalid @enderror"
                                ...
                                @foreach ($bahanBakus as $bahanBaku)
                                    <option value="{{ $bahanBaku->bahan_baku_id }}"
                                        @if (in_array($bahanBaku->bahan_baku_id, old('bahan_baku', $selectedBahanBaku ?? []))) selected @endif>
                ...
                $(".bahan-baku-select").select2({
                    ...
                    language: {
                        ...
                        maximumSelected: function(args) {
                            return "Anda hanya dapat memilih maksimal " + args.maximum +
                                " bahan baku.";
                        }
                    }
                });
