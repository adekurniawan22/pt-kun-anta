...
<head>
    ...
    <link rel="icon" href="<?= url('assets/onedash') ?>/images/icon.jpg" type="image/jpg" />
                    ...
                    <a class="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                        <div class="user-setting d-flex align-items-center gap-3">
                            ...
                            <div class="d-none d-sm-block">
                                ...
                                <small
                                    class="mb-0 dropdown-user-designation">{{ ucwords(str_replace('_', ' ', strtolower($pengguna->role))) }}</small>
                            </div>
                        </div>
                    </a>
